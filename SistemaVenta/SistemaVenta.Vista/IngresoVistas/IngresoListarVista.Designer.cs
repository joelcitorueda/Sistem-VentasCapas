namespace SistemaVenta.Vista.IngresoVistas
{
	partial class IngresoListarVista
	{
		...
		private void InitializeComponent()
		{
			...
			dataGridView1.Size = new Size(980, 426);
			dataGridView1.TabIndex = 0;
			// 
			// button4
			// 
			button4.Location = new Point(491, 453);
			...
			// button3
			// 
			button3.Location = new Point(320, 453);
			...
			// button2
			// 
			button2.Location = new Point(151, 453);
