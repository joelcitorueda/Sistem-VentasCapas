namespace SistemaVenta.Vista.DetalleVentaVistas
{
	partial class DetalleVentaListarVista
	{
		...
		private void InitializeComponent()
		{
			...
			dataGridView1.Size = new Size(915, 426);
			dataGridView1.TabIndex = 0;
			// 
			// button4
			// 
			button4.Location = new Point(459, 464);
			...
			// button3
			// 
			button3.Location = new Point(288, 464);
			...
			// button2
			// 
			button2.Location = new Point(119, 464);
			...
			button1.Location = new Point(664, 464);
