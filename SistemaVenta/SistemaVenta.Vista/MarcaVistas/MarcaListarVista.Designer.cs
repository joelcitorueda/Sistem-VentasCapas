namespace SistemaVenta.Vista.MarcaVistas
{
	partial class MarcaListarVista
	{
		...
		private void InitializeComponent()
		{
			...
			dataGridView1.Size = new Size(923, 426);
			dataGridView1.TabIndex = 0;
			// 
			// button4
			// 
			button4.Location = new Point(482, 455);
			...
			// button3
			// 
			button3.Location = new Point(311, 455);
			...
			// button2
			// 
			button2.Location = new Point(142, 455);
			...
			button1.Location = new Point(687, 455);
