namespace SistemaVenta.Vista.TipoProdVistas
{
	partial class TipoProdListarVista
	{
		...
		private void InitializeComponent()
		{
			...
			dataGridView1.Size = new Size(922, 426);
			dataGridView1.TabIndex = 0;
			// 
			// button4
			// 
			button4.Location = new Point(471, 464);
			...
			// button3
			// 
			button3.Location = new Point(300, 464);
			...
			// button2
			// 
			button2.Location = new Point(131, 464);
			...
			button1.Location = new Point(676, 464);
