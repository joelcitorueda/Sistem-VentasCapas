namespace SistemaVenta.Vista.ProveeVistas
{
	partial class ProveeListarVista
	{
		...
		private void InitializeComponent()
		{
			...
			dataGridView1.Size = new Size(894, 426);
			dataGridView1.TabIndex = 0;
			// 
			// button4
			// 
			button4.Location = new Point(456, 447);
			...
			// button3
			// 
			button3.Location = new Point(285, 447);
			...
			// button2
			// 
			button2.Location = new Point(116, 447);
			...
			button1.Location = new Point(661, 447);
