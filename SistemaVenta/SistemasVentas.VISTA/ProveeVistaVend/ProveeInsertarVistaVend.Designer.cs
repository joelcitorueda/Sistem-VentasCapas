...
{
	partial class ProveeInsertarVistaVend
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			pictureBox1.Location = new Point(194, 74);
			...
			label6.Location = new Point(130, 26);
			label6.Name = "label6";
			...
			button4.Location = new Point(304, 335);
			...
			button3.Location = new Point(304, 257);
			...
			textBox3.Location = new Point(91, 476);
			...
			dateTimePicker1.Location = new Point(91, 400);
			...
			label7.Location = new Point(69, 377);
			label7.Name = "label7";
			...
			button2.Location = new Point(264, 553);
			...
			button1.Location = new Point(141, 553);
			...
			textBox2.Location = new Point(91, 335);
			...
			textBox1.Location = new Point(91, 257);
			...
			label3.Location = new Point(69, 453);
			label3.Name = "label3";
			...
			label2.Location = new Point(69, 312);
			label2.Name = "label2";
			...
			label1.Location = new Point(69, 234);
			label1.Name = "label1";
			label1.Size = new Size(109, 20);
			label1.TabIndex = 80;
			label1.Text = "ID PRODUCTO";
			// 
			// ProveeInsertarVistaVend
			// 
			AutoScaleDimensions = new SizeF(8F, 20F);
			AutoScaleMode = AutoScaleMode.Font;
			BackColor = Color.DarkSlateBlue;
			ClientSize = new Size(541, 627);
			...
			Controls.Add(label2);
			Controls.Add(label1);
			Name = "ProveeInsertarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "ProveeInsertarVistaVend";
