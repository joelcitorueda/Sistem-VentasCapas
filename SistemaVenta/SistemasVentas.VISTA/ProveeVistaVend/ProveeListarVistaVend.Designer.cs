...
{
	partial class ProveeListarVistaVend
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ProveeListarVistaVend));
			...
			button19.Location = new Point(14, 13);
			...
			pServicios.Location = new Point(683, 62);
			...
			label2.TabIndex = 35;
			label2.Text = "ADMINISTRACION DE PROVEE";
			// 
			// button5
			// 
			button5.Image = (Image)resources.GetObject("button5.Image");
			button5.Location = new Point(779, 23);
			...
			button3.Location = new Point(234, 86);
			...
			button2.Location = new Point(30, 86);
			...
			button1.Location = new Point(439, 86);
			...
			dataGridView1.Location = new Point(75, 213);
			...
			// 
			// ProveeListarVistaVend
			// 
			AutoScaleDimensions = new SizeF(8F, 20F);
			AutoScaleMode = AutoScaleMode.Font;
			BackColor = Color.DarkSlateBlue;
			ClientSize = new Size(889, 625);
			...
			Name = "ProveeListarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "ProveeListarVistaVend";
			Load += ProveeListarVistaVend_Load;
