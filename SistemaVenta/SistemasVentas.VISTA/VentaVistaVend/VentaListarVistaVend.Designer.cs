...
{
	partial class VentaListarVistaVend
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(VentaListarVistaVend));
			...
			button19.Location = new Point(18, 18);
			...
			pServicios.Location = new Point(752, 60);
			pServicios.Name = "pServicios";
			pServicios.Size = new Size(158, 548);
			pServicios.TabIndex = 47;
			...
			button5.Location = new Point(850, 18);
			...
			label2.Location = new Point(245, 18);
			label2.Name = "label2";
			label2.Size = new Size(479, 40);
			label2.TabIndex = 44;
			label2.Text = "ADMINISTRACION DE VENTAS";
			// 
			// button3
			// 
			...
			button3.Location = new Point(217, 84);
			...
			button2.Location = new Point(38, 84);
			...
			button1.Location = new Point(397, 84);
			...
			dataGridView1.Location = new Point(104, 198);
			...
			dataGridView1.Size = new Size(806, 389);
			dataGridView1.TabIndex = 39;
			// 
			// VentaListarVistaVend
			// 
			...
			Name = "VentaListarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "VentaListarVistaVend";
			Load += VentaListarVistaVend_Load;
