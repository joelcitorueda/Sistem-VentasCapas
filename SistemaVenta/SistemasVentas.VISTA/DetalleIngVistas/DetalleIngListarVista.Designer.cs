namespace SistemasVentas.VISTA.DetalleIngVistas
{
    partial class DetalleIngListarVista
    {
		...
		private void InitializeComponent()
		{
			...
			dataGridView1.Size = new Size(777, 437);
			dataGridView1.TabIndex = 2;
			// 
			// button4
			// 
			button4.Location = new Point(382, 470);
			...
			// button3
			// 
			button3.Location = new Point(260, 470);
			...
			// button2
			// 
			button2.Location = new Point(139, 470);
			...
			button1.Location = new Point(554, 470);
