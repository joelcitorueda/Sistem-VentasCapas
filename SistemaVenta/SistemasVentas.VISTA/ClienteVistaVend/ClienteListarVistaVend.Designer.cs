namespace SistemasVentas.VISTA.ClienteVistaVend
{
	partial class ClienteListarVistaVend
	{
		...
		private void InitializeComponent()
		{
			...
			button19.Location = new Point(7, 9);
			...
			pServicios.Location = new Point(690, 45);
			pServicios.Name = "pServicios";
			pServicios.Size = new Size(158, 548);
			pServicios.TabIndex = 34;
			...
			button5.Location = new Point(786, 5);
			...
			label2.Location = new Point(175, 17);
			label2.Name = "label2";
			label2.Size = new Size(509, 40);
			label2.TabIndex = 32;
			...
			button3.Location = new Point(211, 69);
			...
			button2.Location = new Point(32, 69);
			...
			button1.Location = new Point(392, 69);
			...
			dataGridView1.Size = new Size(729, 389);
			...
			Load += ClienteListarVistaVend_Load;
