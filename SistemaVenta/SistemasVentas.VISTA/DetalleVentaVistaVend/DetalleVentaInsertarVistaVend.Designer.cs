...
{
	partial class DetalleVentaInsertarVistaVend
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			pictureBox1.Location = new Point(191, 93);
			...
			label6.Location = new Point(94, 53);
			label6.Name = "label6";
			label6.Size = new Size(315, 28);
			label6.TabIndex = 59;
			label6.Text = "INSERTAR DETALLE VENTA";
			// 
			// button4
			// 
			button4.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
			button4.Location = new Point(280, 326);
			...
			button3.Location = new Point(280, 263);
			...
			textBox5.Location = new Point(94, 515);
			...
			textBox4.Location = new Point(94, 450);
			...
			textBox3.Location = new Point(94, 389);
			...
			textBox2.Location = new Point(94, 326);
			...
			textBox1.Location = new Point(94, 263);
			...
			label4.Location = new Point(66, 427);
			label4.Name = "label4";
			...
			label3.Location = new Point(66, 366);
			label3.Name = "label3";
			...
			label2.Location = new Point(67, 303);
			label2.Name = "label2";
			...
			button2.Location = new Point(271, 573);
			...
			button1.Location = new Point(144, 573);
			...
			// 
			// DetalleVentaInsertarVistaVend
			// 
			AutoScaleDimensions = new SizeF(8F, 20F);
			AutoScaleMode = AutoScaleMode.Font;
			BackColor = Color.DarkSlateBlue;
			ClientSize = new Size(494, 674);
			...
			Name = "DetalleVentaInsertarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "DetalleVentaInsertarVistaVend";
