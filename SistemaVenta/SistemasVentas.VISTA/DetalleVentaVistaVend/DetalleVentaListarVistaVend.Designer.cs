...
{
	partial class DetalleVentaListarVistaVend
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DetalleVentaListarVistaVend));
			...
			pServicios.Location = new Point(988, 60);
			...
			button1.Location = new Point(439, 63);
			...
			button3.Location = new Point(231, 63);
			...
			button5.Location = new Point(1084, 14);
			...
			dataGridView1.Location = new Point(46, 163);
			...
			// 
			// DetalleVentaListarVistaVend
			// 
			AutoScaleDimensions = new SizeF(8F, 20F);
			AutoScaleMode = AutoScaleMode.Font;
			BackColor = Color.DarkSlateBlue;
			ClientSize = new Size(1189, 662);
			...
			Name = "DetalleVentaListarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "DetalleVentaListarVistaVend";
			Load += DetalleVentaListarVistaVend_Load;
