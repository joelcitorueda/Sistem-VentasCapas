...
{
	partial class TipoProdInsertarVistaVend
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			pictureBox1.Location = new Point(164, 95);
			...
			button2.Location = new Point(245, 438);
			...
			textBox2.Location = new Point(74, 365);
			...
			textBox1.Location = new Point(74, 290);
			...
			label3.Location = new Point(43, 342);
			label3.Name = "label3";
			...
			label1.Text = "NOMBRE";
			// 
			// TipoProdInsertarVistaVend
			// 
			AutoScaleDimensions = new SizeF(8F, 20F);
			AutoScaleMode = AutoScaleMode.Font;
			BackColor = Color.DarkSlateBlue;
			ClientSize = new Size(496, 499);
			...
			Controls.Add(label3);
			Controls.Add(label1);
			Name = "TipoProdInsertarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "TipoProdInsertarVistaVend";
