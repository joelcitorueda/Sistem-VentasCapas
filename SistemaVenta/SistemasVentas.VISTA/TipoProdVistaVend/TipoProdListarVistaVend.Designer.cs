...
{
	partial class TipoProdListarVistaVend
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TipoProdListarVistaVend));
			...
			button19.Location = new Point(21, 15);
			button19.Name = "button19";
			button19.Size = new Size(73, 34);
			...
			pServicios.Location = new Point(643, 52);
			...
			button5.Location = new Point(739, 15);
			...
			button3.Location = new Point(278, 80);
			...
			button2.Location = new Point(86, 80);
			...
			button1.Location = new Point(461, 80);
			...
			dataGridView1.Location = new Point(167, 203);
			...
			// 
			// TipoProdListarVistaVend
			// 
			AutoScaleDimensions = new SizeF(8F, 20F);
			AutoScaleMode = AutoScaleMode.Font;
			BackColor = Color.DarkSlateBlue;
			ClientSize = new Size(842, 610);
			...
			Name = "TipoProdListarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "TipoProdListarVistaVend";
			Load += TipoProdListarVistaVend_Load;
