namespace SistemasVentas.VISTA.ProductoVistasVend
{
	partial class ProductoListarVistaVend
	{
		...
		private void InitializeComponent()
		{
			...
			pServicios.Location = new Point(573, 40);
			pServicios.Name = "pServicios";
			pServicios.Size = new Size(158, 517);
			pServicios.TabIndex = 29;
			...
			label1.Location = new Point(66, 110);
			label1.Name = "label1";
			label1.Size = new Size(218, 25);
			label1.TabIndex = 26;
			label1.Text = "LISTADO DE PRODUCTO";
			// 
			// button3
			// 
			button3.Location = new Point(212, 50);
			...
			// button2
			// 
			button2.Location = new Point(32, 50);
			...
			button1.Location = new Point(394, 50);
			...
			dataGridView1.Location = new Point(66, 142);
