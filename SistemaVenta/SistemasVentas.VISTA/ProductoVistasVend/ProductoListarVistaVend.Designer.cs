...
{
	partial class ProductoListarVistaVend
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ProductoListarVistaVend));
			...
			button19.Location = new Point(1032, 13);
			...
			pServicios.Location = new Point(936, 62);
			pServicios.Name = "pServicios";
			pServicios.Size = new Size(158, 548);
			pServicios.TabIndex = 35;
			...
			label2.Location = new Point(256, 24);
			label2.Name = "label2";
			...
			button3.Location = new Point(219, 79);
			...
			button2.Location = new Point(34, 79);
			...
			button1.Location = new Point(409, 79);
			...
			dataGridView1.Location = new Point(76, 206);
			...
			Name = "ProductoListarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "ProductoListarVistaVend";
			Load += ProductoListarVistaVend_Load;
