namespace SistemasVentas.VISTA.ProductoVistasVend
{
	partial class ProductoEditarVistaVend
	{
		...
		private void InitializeComponent()
		{
			...
			label8.Location = new Point(118, 23);
			label8.Name = "label8";
			...
			button4.Location = new Point(250, 272);
			...
			button3.Location = new Point(250, 223);
			...
			textBox7.Location = new Point(80, 533);
			...
			textBox4.Location = new Point(80, 377);
			...
			textBox5.Location = new Point(80, 434);
			...
			textBox6.Location = new Point(80, 483);
			...
			textBox3.Location = new Point(80, 323);
			...
			textBox2.Location = new Point(80, 274);
			...
			textBox1.Location = new Point(80, 224);
			...
			button2.Location = new Point(250, 578);
			...
			button1.Location = new Point(118, 578);
