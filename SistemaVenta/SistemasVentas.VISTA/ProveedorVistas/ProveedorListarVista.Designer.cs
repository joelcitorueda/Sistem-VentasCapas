namespace SistemasVentas.VISTA.ProveedorVistas
{
    partial class ProveedorListarVista
    {
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ProveedorListarVista));
			...
			button4.Location = new Point(410, 73);
			...
			button3.Location = new Point(222, 73);
			...
			button1.Location = new Point(599, 73);
			...
			button5.Location = new Point(694, 10);
			...
			pServicios.Location = new Point(598, 49);
			...
			dataGridView1.Location = new Point(45, 224);
			...
			button19.Location = new Point(8, 10);
