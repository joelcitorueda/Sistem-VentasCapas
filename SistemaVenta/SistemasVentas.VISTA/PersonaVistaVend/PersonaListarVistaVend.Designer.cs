namespace SistemasVentas.VISTA.PersonaVistaVend
{
	partial class PersonaListarVistaVend
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PersonaListarVistaVend));
			...
			button19.Location = new Point(8, 13);
			...
			pServicios.Location = new Point(813, 62);
			...
			label2.Name = "label2";
			label2.Size = new Size(524, 40);
			label2.TabIndex = 34;
			label2.Text = "ADMINISTRACION DE PERSONAS";
			// 
			// button5
			// 
			...
			button3.Location = new Point(224, 71);
			...
			button2.Location = new Point(23, 71);
			...
			button1.Location = new Point(433, 71);
			...
			dataGridView1.Location = new Point(90, 191);
			...
			dataGridView1.Size = new Size(924, 389);
			dataGridView1.TabIndex = 37;
			// 
			// PersonaListarVistaVend
			// 
			AutoScaleDimensions = new SizeF(8F, 20F);
			AutoScaleMode = AutoScaleMode.Font;
			BackColor = Color.DarkSlateBlue;
			ClientSize = new Size(1023, 652);
			...
			Name = "PersonaListarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "PersonaListarVistaVend";
			Load += PersonaListarVistaVend_Load;
