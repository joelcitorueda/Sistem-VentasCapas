namespace SistemasVentas.VISTA.ProveedorVistaVend
{
	partial class ProveedorListarVistaVend
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ProveedorListarVistaVend));
			...
			pServicios.Location = new Point(626, 53);
			...
			label1.Location = new Point(56, 150);
			label1.Name = "label1";
			label1.Size = new Size(370, 32);
			label1.TabIndex = 35;
			label1.Text = "LISTADO DE PROVEEDORES";
			// 
			// label2
			// 
			...
			label2.TabIndex = 34;
			label2.Text = "ADMINISTRACION DE PROVEEDORES";
			// 
			// button5
			// 
			button5.Image = (Image)resources.GetObject("button5.Image");
			button5.Location = new Point(722, 12);
			...
			button3.Location = new Point(250, 75);
			...
			button2.Location = new Point(56, 75);
			...
			button1.Location = new Point(445, 75);
			...
			dataGridView1.Location = new Point(73, 226);
			...
			Name = "ProveedorListarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "ProveedorListarVistaVend";
			Load += ProveedorListarVistaVend_Load;
