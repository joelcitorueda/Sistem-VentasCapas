namespace SistemasVentas.VISTA.MarcaVistas
{
    partial class MarcaListarVista
    {
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MarcaListarVista));
			...
			button4.Location = new Point(626, 66);
			...
			button3.Location = new Point(233, 66);
			...
			button2.Location = new Point(39, 66);
			...
			button1.Image = Properties.Resources.icons8_eliminar_27;
			button1.ImageAlign = ContentAlignment.MiddleRight;
			button1.Location = new Point(427, 66);
			...
			button5.Location = new Point(726, 3);
			...
			label2.Location = new Point(187, 13);
			label2.Name = "label2";
			...
			pServicios.Location = new Point(630, 41);
			pServicios.Name = "pServicios";
			pServicios.Size = new Size(158, 548);
			pServicios.TabIndex = 26;
			...
			dataGridView1.Location = new Point(121, 188);
			...
			button19.Location = new Point(12, 7);
