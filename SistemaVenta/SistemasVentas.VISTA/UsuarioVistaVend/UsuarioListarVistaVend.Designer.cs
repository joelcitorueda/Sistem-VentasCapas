...
{
	partial class UsuarioListarVistaVend
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UsuarioListarVistaVend));
			...
			button19.Location = new Point(15, 15);
			button19.Name = "button19";
			button19.Size = new Size(124, 34);
			button19.TabIndex = 47;
			...
			pServicios.Location = new Point(799, 61);
			pServicios.Name = "pServicios";
			pServicios.Size = new Size(158, 548);
			pServicios.TabIndex = 45;
			...
			label2.Name = "label2";
			label2.Size = new Size(517, 40);
			label2.TabIndex = 43;
			label2.Text = "ADMINISTRACION DE USUARIOS";
			// 
			// button5
			// 
			button5.Image = (Image)resources.GetObject("button5.Image");
			button5.Location = new Point(897, 17);
			...
			button2.Location = new Point(25, 76);
			...
			button1.Location = new Point(378, 76);
			...
			dataGridView1.Location = new Point(60, 208);
			...
			dataGridView1.Size = new Size(869, 337);
			dataGridView1.TabIndex = 46;
			// 
			// UsuarioListarVistaVend
			// 
			AutoScaleDimensions = new SizeF(8F, 20F);
			AutoScaleMode = AutoScaleMode.Font;
			BackColor = Color.DarkSlateBlue;
			ClientSize = new Size(1004, 607);
			...
			Name = "UsuarioListarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "UsuarioListarVistaVend";
			Load += UsuarioListarVistaVend_Load;
