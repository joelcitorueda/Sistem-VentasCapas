...
{
	partial class UsuarioInsertarVistaVend
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			label6.Location = new Point(150, 36);
			label6.Name = "label6";
			...
			dateTimePicker1.Location = new Point(112, 527);
			dateTimePicker1.Name = "dateTimePicker1";
			dateTimePicker1.Size = new Size(313, 27);
			dateTimePicker1.TabIndex = 147;
			// 
			// textBox3
			// 
			textBox3.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
			textBox3.Location = new Point(112, 449);
			...
			textBox2.Location = new Point(112, 375);
			...
			textBox1.Location = new Point(112, 298);
			...
			label4.Location = new Point(68, 426);
			label4.Name = "label4";
			...
			label3.Location = new Point(68, 504);
			label3.Name = "label3";
			...
			label2.Location = new Point(68, 352);
			label2.Name = "label2";
			...
			label1.Location = new Point(68, 275);
			label1.Name = "label1";
			...
			button2.Location = new Point(293, 609);
			...
			button1.Location = new Point(176, 609);
			...
			// 
			// UsuarioInsertarVistaVend
			// 
			AutoScaleDimensions = new SizeF(8F, 20F);
			AutoScaleMode = AutoScaleMode.Font;
			BackColor = Color.DarkSlateBlue;
			ClientSize = new Size(528, 699);
			...
			Name = "UsuarioInsertarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "UsuarioInsertarVistaVend";
