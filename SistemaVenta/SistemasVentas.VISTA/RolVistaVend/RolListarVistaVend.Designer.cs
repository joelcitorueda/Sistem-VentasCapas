...
{
	partial class RolListarVistaVend
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RolListarVistaVend));
			...
			pServicios.Location = new Point(636, 52);
			...
			button5.Location = new Point(732, 12);
			...
			button3.Location = new Point(242, 96);
			...
			button2.Location = new Point(50, 96);
			...
			button1.Location = new Point(433, 96);
			...
			dataGridView1.Location = new Point(172, 238);
			...
			Name = "RolListarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "RolListarVistaVend";
			Load += RolListarVistaVend_Load;
