...
{
	partial class RolEditarVistaVend
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// pictureBox1
			// 
			pictureBox1.Image = Properties.Resources.icons8_archivo_50;
			pictureBox1.Location = new Point(173, 82);
			...
			label6.Location = new Point(163, 40);
			label6.Name = "label6";
			...
			button2.Location = new Point(263, 449);
			...
			button1.Location = new Point(145, 449);
			...
			textBox2.Location = new Point(83, 367);
			...
			textBox1.Location = new Point(83, 269);
			...
			label3.Location = new Point(33, 344);
			label3.Name = "label3";
			...
			Controls.Add(label3);
			Controls.Add(label1);
			Name = "RolEditarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "RolEditarVistaVend";
