namespace SistemasVentas.VISTA.IngresoVistas
{
    partial class IngresoListarVista
    {
		...
		private void InitializeComponent()
		{
			...
			dataGridView1.Location = new Point(65, 161);
			dataGridView1.Margin = new Padding(3, 4, 3, 4);
			dataGridView1.Name = "dataGridView1";
			dataGridView1.ReadOnly = true;
			dataGridView1.RowHeadersWidth = 51;
			dataGridView1.Size = new Size(691, 390);
			...
			button4.Location = new Point(430, 63);
			...
			button3.Location = new Point(232, 63);
			...
			button2.Location = new Point(32, 63);
			...
			button1.Location = new Point(631, 63);
			...
			label2.Location = new Point(232, 22);
			label2.Name = "label2";
			...
			label1.TabIndex = 15;
			label1.Text = "ADMINISTRACION DE DETALLE INGRESO";
			// 
			// button5
			// 
