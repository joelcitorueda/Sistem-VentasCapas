...
{
	partial class MarcaInsertarVistaVend
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			pictureBox1.Location = new Point(177, 73);
			...
			label6.Location = new Point(140, 29);
			label6.Name = "label6";
			...
			textBox2.Location = new Point(93, 341);
			...
			textBox1.Location = new Point(93, 254);
			...
			label1.Location = new Point(61, 231);
			label1.Name = "label1";
			...
			button2.Location = new Point(257, 466);
			...
			button1.Location = new Point(140, 466);
			...
			// 
			// MarcaInsertarVistaVend
			// 
			AutoScaleDimensions = new SizeF(8F, 20F);
			AutoScaleMode = AutoScaleMode.Font;
			BackColor = Color.DarkSlateBlue;
			ClientSize = new Size(530, 554);
			...
			Name = "MarcaInsertarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "MarcaInsertarVistaVend";
