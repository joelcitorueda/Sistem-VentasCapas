...
{
	partial class MarcaListarVistaVend
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MarcaListarVistaVend));
			...
			button19.Location = new Point(12, 11);
			...
			pServicios.Location = new Point(630, 56);
			...
			label2.Location = new Point(187, 17);
			label2.Name = "label2";
			label2.Size = new Size(487, 40);
			label2.TabIndex = 35;
			label2.Text = "ADMINISTRACION DE MARCAS";
			// 
			// button5
			// 
			button5.Image = (Image)resources.GetObject("button5.Image");
			button5.Location = new Point(726, 7);
			...
			button4.Image = Properties.Resources.icons8_marque_todas_las_27;
			button4.ImageAlign = ContentAlignment.MiddleRight;
			button4.Location = new Point(433, 70);
			...
			button3.Location = new Point(233, 70);
			...
			button2.Location = new Point(39, 70);
			...
			dataGridView1.Location = new Point(121, 192);
			...
			dataGridView1.Size = new Size(503, 300);
			dataGridView1.TabIndex = 38;
			// 
			// MarcaListarVistaVend
			// 
			AutoScaleDimensions = new SizeF(8F, 20F);
			AutoScaleMode = AutoScaleMode.Font;
			BackColor = Color.DarkSlateBlue;
			ClientSize = new Size(845, 609);
			...
			Name = "MarcaListarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "MarcaListarVistaVend";
			Load += MarcaListarVistaVend_Load;
