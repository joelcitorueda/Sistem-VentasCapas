namespace SistemasVentas.VISTA.DetalleIngVistaVend
{
	partial class DetalleIngEditarVistaVend
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			pictureBox1.Location = new Point(205, 74);
			...
			label8.Name = "label8";
			label8.Size = new Size(311, 28);
			label8.TabIndex = 89;
			label8.Text = "EDITAR DETALLE INGRESO";
			// 
			// button4
			// 
			button4.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
			button4.Location = new Point(327, 280);
			...
			button3.Location = new Point(327, 215);
			...
			textBox7.Location = new Point(109, 602);
			...
			textBox6.Location = new Point(109, 538);
			...
			label7.Location = new Point(68, 320);
			label7.Name = "label7";
			...
			label6.Location = new Point(68, 451);
			label6.Name = "label6";
			...
			button2.Location = new Point(291, 650);
			...
			button1.Location = new Point(155, 650);
			...
			textBox5.Location = new Point(109, 474);
			...
			textBox4.Location = new Point(109, 408);
			...
			textBox2.Location = new Point(109, 281);
			...
			label5.Location = new Point(68, 579);
			label5.Name = "label5";
			...
			label4.Location = new Point(68, 515);
			label4.Name = "label4";
			...
			label3.Location = new Point(68, 385);
			label3.Name = "label3";
			...
			label2.Location = new Point(68, 258);
			label2.Name = "label2";
			...
			label1.Location = new Point(68, 193);
			label1.Name = "label1";
			label1.Size = new Size(94, 20);
			label1.TabIndex = 71;
			label1.Text = "ID INGRESO";
			// 
			// DetalleIngEditarVistaVend
			// 
			AutoScaleDimensions = new SizeF(8F, 20F);
			AutoScaleMode = AutoScaleMode.Font;
			BackColor = Color.DarkSlateBlue;
			ClientSize = new Size(544, 724);
			...
			Controls.Add(label2);
			Controls.Add(label1);
			Name = "DetalleIngEditarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "DetalleIngEditarVistaVend";
