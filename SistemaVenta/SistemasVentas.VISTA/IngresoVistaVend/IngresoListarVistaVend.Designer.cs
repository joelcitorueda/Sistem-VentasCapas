...
{
	partial class IngresoListarVistaVend
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(IngresoListarVistaVend));
			...
			button19.Location = new Point(9, 10);
			button19.Name = "button19";
			button19.Size = new Size(64, 34);
			...
			pServicios.Location = new Point(634, 51);
			pServicios.Name = "pServicios";
			pServicios.Size = new Size(158, 548);
			pServicios.TabIndex = 36;
			...
			button5.Location = new Point(730, 12);
			...
			label1.TabIndex = 34;
			label1.Text = "LISTADO DETALLE INGRESO";
			// 
			// label2
			// 
			...
			label2.Name = "label2";
			label2.Size = new Size(645, 40);
			label2.TabIndex = 33;
			label2.Text = "ADMINISTRACION DE DETALLE INGRESO";
			// 
			// button3
			// 
			...
			button3.Location = new Point(229, 70);
			button3.Name = "button3";
			button3.Size = new Size(164, 34);
			button3.TabIndex = 31;
			button3.Text = "EDITAR";
			...
			button2.Location = new Point(29, 70);
			...
			button1.Location = new Point(425, 70);
			...
			dataGridView1.Location = new Point(43, 189);
			...
			dataGridView1.Size = new Size(749, 389);
			dataGridView1.TabIndex = 37;
			// 
			// IngresoListarVistaVend
			// 
			...
			Name = "IngresoListarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "IngresoListarVistaVend";
			Load += IngresoListarVistaVend_Load;
