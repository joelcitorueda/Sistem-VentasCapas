namespace SistemasVentas.VISTA.RolVistas
{
    partial class RolInsertarVista
    {
		...
		private void InitializeComponent()
		{
			...
			button2.Location = new Point(253, 439);
			...
			button1.Location = new Point(135, 439);
			...
			textBox2.Location = new Point(73, 357);
			...
			textBox1.Location = new Point(73, 259);
			...
			label3.Location = new Point(23, 334);
			label3.Name = "label3";
			...
			label1.Location = new Point(23, 236);
			label1.Name = "label1";
			...
			pictureBox1.Location = new Point(163, 72);
