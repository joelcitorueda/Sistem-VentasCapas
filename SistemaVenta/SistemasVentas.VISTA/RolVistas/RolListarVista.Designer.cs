namespace SistemasVentas.VISTA.RolVistas
{
    partial class RolListarVista
    {
		...
		private void InitializeComponent()
		{
			...
			dataGridView1.Location = new Point(116, 186);
			...
			// button4
			// 
			button4.Location = new Point(427, 61);
			...
			// button3
			// 
			button3.Location = new Point(229, 61);
			...
			// button2
			// 
			button2.Location = new Point(30, 61);
			...
			button5.Location = new Point(714, 12);
			...
			pServicios.Location = new Point(618, 51);
			pServicios.Name = "pServicios";
			pServicios.Size = new Size(158, 517);
			pServicios.TabIndex = 19;
