namespace SistemasVentas.VISTA.UsuarioRolVistaVend
{
	partial class UsuarioRolListarVistaVend
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UsuarioRolListarVistaVend));
			...
			button19.Location = new Point(35, 20);
			button19.Name = "button19";
			button19.Size = new Size(62, 34);
			...
			pServicios.Location = new Point(744, 60);
			pServicios.Name = "pServicios";
			pServicios.Size = new Size(158, 548);
			pServicios.TabIndex = 37;
			...
			label1.TabIndex = 36;
			label1.Text = "LISTADO DE USUARIOS ROLES";
			// 
			// label2
			// 
			...
			label2.Name = "label2";
			label2.Size = new Size(590, 40);
			label2.TabIndex = 35;
			label2.Text = "ADMINISTRACION DE USUARIOS ROL";
			// 
			// button5
			// 
			button5.Image = (Image)resources.GetObject("button5.Image");
			button5.Location = new Point(840, 22);
			...
			button3.Location = new Point(239, 71);
			...
			button2.Location = new Point(54, 71);
			...
			button1.Location = new Point(437, 71);
			...
			dataGridView1.Location = new Point(92, 221);
			...
			dataGridView1.Size = new Size(781, 337);
			dataGridView1.TabIndex = 38;
			// 
			// UsuarioRolListarVistaVend
			// 
			AutoScaleDimensions = new SizeF(8F, 20F);
			AutoScaleMode = AutoScaleMode.Font;
			BackColor = Color.DarkSlateBlue;
			ClientSize = new Size(937, 629);
			...
			Name = "UsuarioRolListarVistaVend";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "UsuarioRolListarVistaVend";
			Load += UsuarioRolListarVistaVend_Load;
